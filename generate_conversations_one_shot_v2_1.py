...
Tu tarea es generar 6 conversaciones realistas entre un asistente de IA especializado en estos temas y un usuario.
...
Antes de generar las conversaciones, asegúrate de cumplir cada uno de los siguientes criterios:
    ...
    10. En caso no sea posible proveer una respuesta completa con la infomacion proporcionada sugiere consultar con la oficina del Area de Estadistica y Registros Academicos de la Facultad de ciencias (AERA).
Finalmente, presenta cada una de las 6 conversaciones de la siguiente manera:    
...
Conversaciones generadas:
    ...
    Conversación 6:
            user: una duda han pasado 6 dias desde que aprobaron mi traslado interno a la escuela de fisica, y queria saber si es que ya podria solicitar la convalidacion de cursos.
            asistente: El plazo para realizar convalidaciones de traslados internos se extiende hasta cinco (5) días hábiles contados a partir de la aprobación por parte del Consejo de Facultad o la autorización del Decano, si estas dentro de ese plazo puedes realizar la convalidacion de cursos.
            user: tengo una duda sobre si el curso de fisica iii que lleve en la antes de mi trasaldo puede convalidarse
            ...
            user: a ya entiendo gracias.
            asistente: ¡De nada! Si tienes más consultas, no dudes en preguntar.
            user: no nada mas gracias
            asistente: Si tienes más preguntas o necesitas ayuda en el futuro, no dudes en preguntar. ¡Que tangas un buen dia!
